...
const CommunitiesPage: React.FC = () => {
  ...
  const communities: Community[] = [
    ...
    { id: 6, name: 'Pointe Grand Brunswick', location: 'Brunswick', state: 'GA', units: 264, status: 'Completed', imageUrl: '/Images/Brunswick.jpg', coordinates: [31.1498, -81.4912], yearCompleted: 2023, occupancy: 89, website: 'pointegrandbrunswick.com' },
    ...
    { id: 12, name: 'Pointe Grand Palm Coast', location: 'Palm Coast', state: 'FL', units: 300, status: 'Completed', imageUrl: '/Images/Palm-Coast.jpeg', coordinates: [29.5844, -81.2081], yearCompleted: 2023, occupancy: 95, website: 'pointegrandpalmcoast.com' },
    { id: 13, name: 'Pointe Grand Daytona', location: 'Daytona Beach', state: 'FL', units: 264, status: 'Completed', imageUrl: '/Images/Daytona.jpg', coordinates: [29.2108, -81.0228], yearCompleted: 2022, occupancy: 94, website: 'pointegranddaytona.com' },
    { id: 14, name: 'Pointe Grand DeLand', location: 'DeLand', state: 'FL', units: 264, status: 'Completed', imageUrl: '/Images/Deland.jpg', coordinates: [29.0286, -81.3009], yearCompleted: 2022, occupancy: 97, website: 'pointegranddeland.com' },
    { id: 15, name: 'Pointe Grand Davenport', location: 'Davenport', state: 'FL', units: 288, status: 'Completed', imageUrl: '/Images/Davenport-1.jpg', coordinates: [28.1614, -81.6023], yearCompleted: 2023, occupancy: 91, website: 'pointegranddavenport.com' },
    { id: 16, name: 'Pointe Grand Plant City', location: 'Plant City', state: 'FL', units: 300, status: 'Under Construction', imageUrl: '/Images/Plant-City-1.jpg', coordinates: [28.0186, -82.1129], yearCompleted: 2024, website: 'Website Coming soon' },
    { id: 17, name: 'Pointe Grand Jacksonville West', location: 'Jacksonville', state: 'FL', units: 264, status: 'Completed', imageUrl: '/Images/Jacksonville-West.jpg', coordinates: [30.3322, -81.6557], yearCompleted: 2021, occupancy: 98, website: 'pointegrandjacksonvillewest.com' },
    { id: 18, name: 'Pointe Grand Oak Leaf', location: 'Oak Leaf', state: 'FL', units: 216, status: 'Completed', imageUrl: '/Images/Oakleaf.jpg', coordinates: [30.1755, -81.9009], yearCompleted: 2021, occupancy: 96, website: 'pointegrandoakleaf.com' },
    { id: 19, name: 'Pointe Grand South Lake', location: 'Clermont', state: 'FL', units: 312, status: 'Under Construction', imageUrl: '/Images/Pointe.jpg', coordinates: [28.5494, -81.7729], yearCompleted: 2024, website: 'Website Coming soon' },
    { id: 22, name: 'Pointe Grand Heath Brook', location: 'Ocala', state: 'FL', units: 240, status: 'Completed', imageUrl: '/Images/Heath-Brook.jpg', coordinates: [29.1756, -82.1584], yearCompleted: 2023, occupancy: 93, website: 'pointegrandheathbrook.com' },
    { id: 23, name: 'Pointe Grand Middleburg', location: 'Middleburg', state: 'FL', units: 264, status: 'In Development', imageUrl: '/Images/Middleburg.jpeg', coordinates: [30.0769, -81.8673], yearCompleted: 2025, website: 'Website Coming soon' },
    { id: 24, name: 'Pointe Grand Panama City', location: 'Panama City', state: 'FL', units: 288, status: 'In Development', imageUrl: '/Images/Panama.webp', coordinates: [30.1588, -85.6602], yearCompleted: 2025, website: 'Website Coming soon' },
    { id: 25, name: 'Pointe Grand Spring Hill', location: 'Spring Hill', state: 'FL', units: 276, status: 'In Development', imageUrl: '/Images/Spring-Hill.jpg', coordinates: [28.4769, -82.5268], yearCompleted: 2025, website: 'Website Coming soon' },
    
    // South Carolina Communities
    { id: 20, name: 'Pointe Grand Columbia', location: 'Columbia', state: 'SC', units: 258, status: 'Completed', imageUrl: '/Images/Columbia.jpg', coordinates: [34.0007, -81.0348], yearCompleted: 2022, occupancy: 94, website: 'pointegrandcolumbiasc.com' },
    { id: 21, name: 'Pointe Grand On Main', location: 'Anderson', state: 'SC', units: 288, status: 'Completed', imageUrl: '/Images/Pointe.jpg', coordinates: [34.5034, -82.6501], yearCompleted: 2023, occupancy: 92, website: 'pointegrandonmain.com' },
  ];
